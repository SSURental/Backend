...
public class ItemController {
    ...
    @Operation(summary = "아이템 등록 요청", parameters = {
    ...
    @Operation(summary = "대여 가능한 아이템 목록 요청", parameters = {
        @Parameter(in = ParameterIn.HEADER, name = "X-AUTH_TOKEN", required = true, description = "발급받은 JWT토큰")})
    @ApiResponses(value = {
    ...
    @Operation(summary = "특정 아이템 정보 요청", parameters = {
        @Parameter(in = ParameterIn.HEADER, name = "X-AUTH_TOKEN", required = true, description = "발급받은 JWT토큰")})
    @ApiResponses(value = {
    ...
    @Operation(summary = "특정 아이템 삭제 요청", parameters = {
        @Parameter(in = ParameterIn.HEADER, name = "X-AUTH_TOKEN", required = true, description = "발급받은 JWT토큰")})
    @ApiResponses(value = {
