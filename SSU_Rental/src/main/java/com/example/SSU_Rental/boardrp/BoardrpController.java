...
public class BoardrpController {
    ...
    public ResponseEntity<Long> register(@Parameter(description = "게시글 ID",required = true) @PathVariable Long boardId,
    ...
    public ResponseEntity<ResponsePageDTO> getList(@Parameter(description = "게시글 ID",required = true) @PathVariable Long boardId,
...
//    }
    ...
    public ResponseEntity delete(@Parameter(description = "게시글 ID",required = true) @PathVariable Long boardId,@Parameter(description = "댓글 ID",required = true)  @PathVariable Long replyId,
